System.register(['jmgraph'], function (exports) {
  'use strict';
  var jmArrowLine, jmRect, jmPath, jmList, jmControl, jmLine, jmGraph, jmUtils;
  return {
    setters: [function (module) {
      jmArrowLine = module.jmArrowLine;
      jmRect = module.jmRect;
      jmPath = module.jmPath;
      jmList = module.jmList;
      jmControl = module.jmControl;
      jmLine = module.jmLine;
      jmGraph = module.jmGraph;
      jmUtils = module.jmUtils;
    }],
    execute: function () {
